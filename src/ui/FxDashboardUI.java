...
public final class FxDashboardUI {
    ...
    private static ScrollPane buildExploreView(Stage stage) {
        ...
        List<String[]> challenges = List.of(
            new String[]{"AI-Powered Supply Chain Optimizer", "Acme Corp", "INR 5,00,000"},
            new String[]{"Carbon Footprint Tracker", "GreenTech", "INR 2,00,000"},
            new String[]{"Smart Inventory Management", "TechVision", "INR 3,50,000"}
        );

        for (String[] c : challenges) {
            Label name = new Label(c[0]);
            name.getStyleClass().add("table-title");
            Label meta = new Label(c[1] + " • Prize: " + c[2]);
